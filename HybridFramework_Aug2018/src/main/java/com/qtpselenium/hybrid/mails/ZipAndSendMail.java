...
public class ZipAndSendMail
{
	...
	static String[] toEmails = { "vrush.haldankar@gmail.com","govind.3555@gmail.com" };
	static String fromUser = "vrush.haldankar";//just the id alone without @gmail.com
	static String password = "vrush.123";
